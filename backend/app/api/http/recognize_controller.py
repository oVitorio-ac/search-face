...
def _assess_face_quality(box, landmarks):
    ...
    elif landmark_style != "insightface_5pt":
    ...
    elif landmark_style != "insightface_5pt" and len(nose_tip) < 3:
        reasons.append("partial_nose_landmarks")
...
def recognize_faces():
    try:
        ...
        use_case = RecognizeFacesUseCase(face_engine=FaceEngine(), matcher=FaceMatcher(), threshold=1.0)
